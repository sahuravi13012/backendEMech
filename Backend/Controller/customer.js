...
const updatecustomer = async (req, res) => {
  try {
    const data = [
      ...
      req.body.req.body.blocked_by_admin,
      req.body.unblock_by_admin,
    ];
...
const totalCustomer = async (req, res) => {
  try {
    let sqlquery = "SELECT COUNT(customer_id) FROM tbl_customer";
...
module.exports = { getcustomer, postcustomer, deletecustomer, updatecustomer,totalCustomer };
